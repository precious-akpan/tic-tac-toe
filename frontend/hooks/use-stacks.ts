...
import {AppConfig, openContractCall, showConnect, type UserData, UserSession,} from "@stacks/connect";
import {PostConditionMode} from "@stacks/transactions";
import {useEffect, useState} from "react";

const appDetails = {name: "Tic Tac Toe", icon: "https://cryptologos.cc/logos/stacks-stx-logo.png",};
...
export function useStacks() {
    ...
    async function handleCreateGame(betAmount: number, moveIndex: number, move: Move) {
        ...
        try {
            ...
            await openContractCall({
                ...txOptions, appDetails, onFinish: (data) => {
                    console.log(data);
    ...
    return {userData, stxBalance, connectWallet, disconnectWallet, handleCreateGame, handleJoinGame, handlePlayGame,};
}